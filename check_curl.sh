...
#login page
var=`curl -s --request GET 'http://caroc.duckdns.org/login/'`
...
#register page
var=`curl -s --request GET 'http://caroc.duckdns.org/register/'`
...
#R-Nu
var=`curl -s --request POST 'http://caroc.duckdns.org/register/'`
...
#R-U-Np
var=`curl -s -X POST -d "username=mario.espinoza" 'http://caroc.duckdns.org/register/'`
...
#R-U-P
var=`curl -s -X POST -d "username=j&password=1234" 'http://caroc.duckdns.org/register/'`
...
#R-U-P-repeated
var=`curl -s -X POST -d "username=mario.espinoza&password=1234" 'http://caroc.duckdns.org/register/'`
...
#L-Nu
var=`curl -s --request POST 'http://caroc.duckdns.org/login/'`
...
#L-U-Np
var=`curl -s -X POST -d "username=mario.espinoza" 'http://caroc.duckdns.org/login/'`
...
#L-Wu-Np
var=`curl -s -X POST -d "username=mario" 'http://caroc.duckdns.org/login/'`
if [ "$var" = "Incorrect username." ]; then
...
#L-U-Wp
var=`curl -s -X POST -d "username=mario.espinoza&password=1238" 'http://caroc.duckdns.org/login/'`
if [ "$var" = "Incorrect password." ]; then
...
#L-U-P
var=`curl -s -X POST -d "username=mario.espinoza&password=1234" 'http://caroc.duckdns.org/login/'`
